      ...
      <section className="bg-neutral-50">
        <div className="mx-auto grid max-w-[1180px] items-center gap-10 px-5 py-20 sm:px-10 md:grid-cols-2">
          ...
          <ul className="grid gap-3">
            {["Diepe kennis van Wmo, Jeugd, Participatie en Schuldhulp", "Een warm netwerk van professionals", "Korte lijnen en een vaste contactpersoon", "Alles netjes geregeld volgens cao"].map((p) => (
